...
export type LoadProjection = (args: LoadProjectionArgs) => TE.TaskEither<PipelineError, unknown>

type ProjectionPipelineArgs<EntityState, DomainEvent, Payload> = {
...
type ActionPipeline = <EntityState, DomainEvent, Payload>(args: ActionPipelineArgs<EntityState, DomainEvent, Payload>)=> (entityId: string, payload: Payload) => TE.TaskEither<PipelineError, void>
